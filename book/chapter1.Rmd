...
# Installing the packages "foreign", "haven" and "tidyverse" (both to be introduced later) is done with the following command in R:

install.packages("foreign", "haven", "tidyverse")
...
- `foreign` (sometimes maybe `haven`) to import SPSS, Stata, and SAS data;
